...
class Animal{
	...
	// Animal 있고, 각 하위 클래스에서 재정의 해서 사용을 합니다.
...
class Lsy extends Animal{
	...
	public void eat()
	{
		System.out.println("상용이가 밥을 먹습니다. ");
	}
	public void sound()
	{
		System.out.println("상용이가 말을합니다. ");
	}
}
